...
* **🌍 Multi-language Support:** **English is the default language.** The extension also fully supports **French, Spanish, Portuguese, Chinese, Thai, and Russian** based on your browser settings.
...
1.  **Download** https://github.com/AinsTitor/Gemini-Ultimate-Organizer/releases/download/1.5/geminiultimatefolderv1.5.zip or **Clone** this repository to your computer. 
...
* **No Data Collection:** This extension does not collect or send any personal data to external servers.
* **Local & Sync Storage:** Your folder structure is stored securely within your own Chrome browser storage (synced via your Google account).
...
* **🌍 Multi-langues :** **L'anglais est la langue par défaut.** L'extension supporte également le **Français, l'Espagnol, le Portugais, le Chinois, le Thaïlandais et le Russe** selon la configuration de votre navigateur.
...
1.  **Téléchargez** https://github.com/AinsTitor/Gemini-Ultimate-Organizer/releases/download/1.5/geminiultimatefolderv1.5.zip ou **Clonez** ce dépôt sur votre ordinateur.
...
* **Share / Partager :** Copy and redistribute the material in any medium or format.
* **Adapt / Adapter :** Remix, transform, and build upon the material.
